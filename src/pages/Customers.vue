...
<v-container fluid class="pa-0">
        ...
        <v-col cols="12">
            <v-card>
                <v-toolbar class="bg-white">
                    <v-text-field v-model="search" placeholder="Aranacak kelimeyi girin..." label="Ara" variant="outlined" hide-details single-line></v-text-field>
                ...
                <v-data-table :headers="headers" :items="customerList" :search="search" :loading="loading" :items-per-page="10" show-select class="data-table-responsive">
    ...
    <CustomerDialog v-if="dialog" :isVisible="dialog" :process-type="processType" :customer-list="customerList" :editing-customer="editedCustomer" @update:isVisible="dialog = $event" />
